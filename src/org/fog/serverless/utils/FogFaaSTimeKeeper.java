...
public class FogFaaSTimeKeeper {

	private static FogFaaSTimeKeeper instance;
	...
	public static FogFaaSTimeKeeper getInstance(){
		if(instance == null)
			instance = new FogFaaSTimeKeeper();
		return instance;
	}
	...
	public void tupleStartedExecution(FogFaaSTuple tuple){
		tupleIdToCpuStartTime.put(tuple.getCloudletId(), CloudSim.clock());
	}
	
	public void tupleEndedExecution(FogFaaSTuple tuple){
