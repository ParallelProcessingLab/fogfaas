...
/**
 * Class representing an application module, the processing elements of the application model of iFogSim for FoGFaaS extension.
 *
 * @author Ghaseminya
 * Created on 12/16/2024
 */
public class FogFaaSAppModule extends PowerVm{

	private String name;
	private String appId;
	private boolean isFaaS;
	...
	public FogFaaSAppModule(FogFaaSAppModule operator) {
	...
	public boolean isFaaS() {
		return isFaaS;
	}
	public void setFaaS(boolean isFaaS) {
		this.isFaaS = isFaaS;
	}
}
