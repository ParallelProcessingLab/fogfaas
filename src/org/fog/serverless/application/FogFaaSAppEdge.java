...
public class FogFaaSAppEdge {
	...
	public FogFaaSAppEdge(){
		
	}
	
	public FogFaaSAppEdge(String source, String destination, double tupleCpuLength, 
	...
	public FogFaaSAppEdge(String source, String destination, double periodicity, double tupleCpuLength, 
			double tupleNwLength, String tupleType, int direction, int edgeType){
		setSource(source);
		setDestination(destination);
		setTupleCpuLength(tupleCpuLength);
